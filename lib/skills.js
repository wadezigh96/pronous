...
const SKILLS = [
  ...
  {id:"proof_of_action",name:"Proof of Action",icon:"◈",purpose:"Creates tamper-evident proof for each agent action from intent through confirmation or execution.",output:"verifiable POA record",risk:"evidence-only"}
];
